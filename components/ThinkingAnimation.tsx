  ...
  return (
    <div className="thinking-container">
      ...
      <div className="people-container">
        <Image src="/assets/images/personleft.png" alt="Person 1" width={85} height={85} className="person person-1" />
        {conversationStarted && (
          <>
        ...
        <Image src="/assets/images/personright.png" alt="Person 2" width={85} height={85} className="person person-2" />
      </div>
    </div>
  );
}